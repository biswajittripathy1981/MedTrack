...
namespace Medtrack.DAL
{
    public class MedDbContext:DbContext
    {
        ...
        private void InitializeDB()
        {
            ...
            Medicines.Add(new Medicine() { Name = "Azythromycin", Brand = "GKLAB", Price = 30, Quantity = 9, ExpiryDate = new DateTime(2021, 07, 26), Notes = "Covid category Anti Biotic" });
            Medicines.Add(new Medicine() { Name = "Dolo650", Brand = "Lab2", Price = 40, Quantity = 70, ExpiryDate = new DateTime(2020, 10, 10), Notes = "Covid category Bodyache" });
